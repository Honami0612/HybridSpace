...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            //Vector3 camPos = new Vector3(m_Target.transform.position.x, 0, m_Target.transform.position.z);
            //transform.position = Vector3.Lerp(transform.position, camPos, deltaTime * m_MoveSpeed);
